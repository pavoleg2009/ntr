...
struct Address {
    ...
    var gps_lat: CLLocationDegrees? // 56.233969
    var gps_lng: CLLocationDegrees? // 43.388959
    ...
    init?(json: [String:Any]?) {
        ...
        self.gps_lat = json["gps_lat"] as? CLLocationDegrees
        self.gps_lng = json["gps_lng"] as? CLLocationDegrees
    }
}
